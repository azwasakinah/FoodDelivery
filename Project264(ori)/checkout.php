...
<head>
    ...
    <link rel="stylesheet" href="checkout_query.css">
            ...
            <div class="contact-box">
                <div class="contact-area">
                    <div class="contact-header">
                        <h4 class="header-text"> ORDER FORM</h4>
                        <p class="mb-0">(FoodieKing Delivery) </p>
                    </div>
                        ...
                        <form method="post" id="contact-form" autocomplete="off">
                            ...
                            <div class="contact-field">
                                <div class="contact-field-msg-sub">
                                    <label class="label-text">Additional Message *</label>
                            ...
                            <div class="contact-field">
                                <div class="success-msg"> Thank You For Ordering with Us. </div>
                            </div>    
                            <div class="contact-field">
        ...
        $('#contact-form').validate({
            ...
            messages : {
                ...
                phone : {
                    ...
                    regex : 'Please Enter Valid Number (Malaysia)' 
                },
                msg : {
